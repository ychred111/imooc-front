<template>
  ...
  >
    ...
    <transition name="slide">
      <div
        class="max-h-[368px] w-full text-base overflow-auto bg-slate-700 absolute z-20 left-0 top-[56px] p-2 rounded border-border-zinc-200 duration-200 hover:shadow-3xl"
      >
        <slot name="dropdown" />
      </div>
    </transition>
