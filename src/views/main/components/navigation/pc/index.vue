  ...
  <div class="bg-white dark:bg-zinc-800 sticky top-0 left-0 w-full z-10">
    ...
    >
      ...
      <li
        ...
        :key="item.id"
        class="shrink-0 px-1.5 py-0 z-10 duration-200 last:mr-4 text-zinc-900 text-base dark:text-zinc-300 font-bold h-4 leading-4 cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-900 dark:hover:text-zinc-300 rounded mr-1 mb-1"
        :class="{
