<template>
  <div
    class="w-full bg-white border-b border-b-zinc-200 dark:bg-zinc-900 dark:border-b-zinc-900 px-2 py-1"
  >
...
import headerThemeVue from './header-theme/index.vue'
import headerMyVue from './header-my/index.vue'
